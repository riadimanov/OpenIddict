    ...
    public class AuthenticationController : Controller
    {
        ...
        public IActionResult LogIn(string returnUrl)
        {
            try
            {
                ...
                {
                    [OpenIddictClientAspNetCoreConstants.Properties.Issuer] = "https://localhost:7200"
                });
                properties.RedirectUri = Url.IsLocalUrl(returnUrl) ? returnUrl : "/";

                // Use the Challenge method to initiate the OpenIddict authentication process.
            ...
            catch (Exception ex)
            {
                ...
                // You can also inspect the exception details to understand the issue better.
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            RefreshTokenRequest refreshTokenRequest = new RefreshTokenRequest()
            {
                ...
                Address = (await httpClient.GetDiscoveryDocumentAsync("https://localhost:7200")).TokenEndpoint
            };
